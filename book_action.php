...
if ($source == $dest) {
  ...
  echo "<h1>
  <center><b><img src='images/route.png'>SELECT ROUTE AND PROCEED TO CHECKOUT :</center></b>
  </h1>";
...
<center>
  <td>
    <form action="book.php"><button type="submit" style="background-color: black; padding: 28px 80px; align-items:center;"><span style=color:white;>
          <h3>Go back</h3>
        </span></a>
